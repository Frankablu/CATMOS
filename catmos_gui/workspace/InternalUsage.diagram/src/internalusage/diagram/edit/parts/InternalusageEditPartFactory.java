 ...
 * @generated
 */
public class InternalusageEditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case MainEditPart.VISUAL_ID:
				return new MainEditPart(view);

			case ValuePairEditPart.VISUAL_ID:
				return new ValuePairEditPart(view);

			case ValuePairNameEditPart.VISUAL_ID:
				return new ValuePairNameEditPart(view);
			}
		}
