 ...
 * @generated
 */
public class InternalusageValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = InternalusageDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof InternalusageDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& MainEditPart.MODEL_ID.equals(InternalusageVisualIDRegistry
						.getModelID(view));
	}
