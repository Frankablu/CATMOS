...
import internalusage.diagram.part.InternalusageDiagramEditorUtil;
 ...
 * @generated
 */
public class InternalusageMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = InternalusageDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			InternalusageDiagramEditorUtil.selectElementsInDiagram(editor,
