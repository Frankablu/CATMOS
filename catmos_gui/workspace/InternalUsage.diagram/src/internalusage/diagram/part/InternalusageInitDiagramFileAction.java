 ...
 * @generated
 */
public class InternalusageInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new InternalusageNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				MainEditPart.MODEL_ID));
		InternalusageDiagramEditorUtil.runWizard(getShell(), wizard,
