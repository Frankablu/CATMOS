 ...
 * @generated
 */
public class InternalusageElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public InternalusageElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						Messages.InternalusageElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "internalusage".equals(fileExtension); //$NON-NLS-1$
	}
