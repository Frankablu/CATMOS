...
public class CapabilityAccumulationReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof CapOverTime.Measurement && newEnd instanceof CapOverTime.Capability)) {
			return false;
		}
	...
	protected boolean canReorientTarget() {
		if (!(oldEnd instanceof CapOverTime.Measurement && newEnd instanceof CapOverTime.Measurement)) {
			return false;
		}
		return CapOverTime.diagram.edit.policies.CapOverTimeBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistCapabilityAccumulation_4001(
	 ...
	 * @generated
	 */
	protected CapOverTime.Measurement getOldTarget() {
		return (CapOverTime.Measurement) oldEnd;
	}

	/**
	 * @generated
	 */
	protected CapOverTime.Measurement getNewTarget() {
		return (CapOverTime.Measurement) newEnd;
	}
}
