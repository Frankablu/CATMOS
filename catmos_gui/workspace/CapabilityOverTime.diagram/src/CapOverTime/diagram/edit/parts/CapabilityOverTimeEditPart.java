 ...
 * @generated
 */
public class CapabilityOverTimeEditPart extends DiagramEditPart {

	/**
	 * @generated
	 */
	public final static String MODEL_ID = "CapOverTime"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public CapabilityOverTimeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new CapOverTime.diagram.edit.policies.CapabilityOverTimeItemSemanticEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new CapOverTime.diagram.edit.policies.CapabilityOverTimeCanonicalEditPolicy());
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new CapOverTime.diagram.edit.commands.CapOverTimeCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
