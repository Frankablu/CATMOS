...
public class MeasurementEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new CapOverTime.diagram.edit.policies.MeasurementItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CapOverTime.diagram.edit.parts.MeasurementNameEditPart) {
			((CapOverTime.diagram.edit.parts.MeasurementNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureMeasurementLabelFigure());
			return true;
		}
		if (childEditPart instanceof CapOverTime.diagram.edit.parts.MeasurementMeasurementCriticalValuesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getMeasurementCriticalValuesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((CapOverTime.diagram.edit.parts.MeasurementMeasurementCriticalValuesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof CapOverTime.diagram.edit.parts.MeasurementMeasurementBenchmarkValuesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getMeasurementBenchmarkValuesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((CapOverTime.diagram.edit.parts.MeasurementMeasurementBenchmarkValuesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof CapOverTime.diagram.edit.parts.MeasurementMeasurementProvidedValuesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getMeasurementProvidedValuesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((CapOverTime.diagram.edit.parts.MeasurementMeasurementProvidedValuesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CapOverTime.diagram.edit.parts.MeasurementMeasurementCriticalValuesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getMeasurementCriticalValuesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((CapOverTime.diagram.edit.parts.MeasurementMeasurementCriticalValuesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof CapOverTime.diagram.edit.parts.MeasurementMeasurementBenchmarkValuesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getMeasurementBenchmarkValuesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((CapOverTime.diagram.edit.parts.MeasurementMeasurementBenchmarkValuesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof CapOverTime.diagram.edit.parts.MeasurementMeasurementProvidedValuesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getMeasurementProvidedValuesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((CapOverTime.diagram.edit.parts.MeasurementMeasurementProvidedValuesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
