 ...
 * @generated
 */
public class CapabilityOverTimeCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return CapOverTime.CapOverTimePackage.eINSTANCE
	...
	protected List getSemanticChildrenList() {
		...
		List<CapOverTime.diagram.part.CapOverTimeNodeDescriptor> childDescriptors = CapOverTime.diagram.part.CapOverTimeDiagramUpdater
				.getCapabilityOverTime_1000SemanticChildren(viewObject);
	...
	protected boolean isOrphaned(Collection<EObject> semanticChildren,
		...
		if (view.getEAnnotation("Shortcut") != null) { //$NON-NLS-1$
			return CapOverTime.diagram.part.CapOverTimeDiagramUpdater
	...
	private boolean isMyDiagramElement(View view) {
		return CapOverTime.diagram.edit.parts.TimePeriodEditPart.VISUAL_ID == CapOverTime.diagram.part.CapOverTimeVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<CapOverTime.diagram.part.CapOverTimeNodeDescriptor> childDescriptors = CapOverTime.diagram.part.CapOverTimeDiagramUpdater
				.getCapabilityOverTime_1000SemanticChildren((View) getHost()
						.getModel());
		...
		for (Iterator<CapOverTime.diagram.part.CapOverTimeNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			CapOverTime.diagram.part.CapOverTimeNodeDescriptor next = descriptorsIterator
					.next();
			String hint = CapOverTime.diagram.part.CapOverTimeVisualIDRegistry
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<CapOverTime.diagram.part.CapOverTimeLinkDescriptor> linkDescriptors = collectAllLinks(
				getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
				.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = CapOverTime.diagram.part.CapOverTimeVisualIDRegistry
			...
			for (Iterator<CapOverTime.diagram.part.CapOverTimeLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				CapOverTime.diagram.part.CapOverTimeLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	 ...
	 * @generated
	 */
	private Collection<CapOverTime.diagram.part.CapOverTimeLinkDescriptor> collectAllLinks(
		...
		case CapOverTime.diagram.edit.parts.CapabilityOverTimeEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CapOverTime.diagram.part.CapOverTimeDiagramUpdater
						.getCapabilityOverTime_1000ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
		...
		case CapOverTime.diagram.edit.parts.TimePeriodEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CapOverTime.diagram.part.CapOverTimeDiagramUpdater
						.getTimePeriod_2001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case CapOverTime.diagram.edit.parts.MeasurementEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CapOverTime.diagram.part.CapOverTimeDiagramUpdater
						.getMeasurement_3002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case CapOverTime.diagram.edit.parts.QualitativeValue3EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CapOverTime.diagram.part.CapOverTimeDiagramUpdater
						.getQualitativeValue_3005ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
	...
	private Collection<IAdaptable> createConnections(
			Collection<CapOverTime.diagram.part.CapOverTimeLinkDescriptor> linkDescriptors,
