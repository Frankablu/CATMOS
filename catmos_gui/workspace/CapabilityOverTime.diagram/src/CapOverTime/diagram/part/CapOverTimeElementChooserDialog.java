 ...
 * @generated
 */
public class CapOverTimeElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public CapOverTimeElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						CapOverTime.diagram.part.Messages.CapOverTimeElementChooserDialog_SelectModelElementTitle);
