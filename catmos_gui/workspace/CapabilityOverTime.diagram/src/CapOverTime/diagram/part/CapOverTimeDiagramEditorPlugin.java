 ...
 * @generated
 */
public class CapOverTimeDiagramEditorPlugin extends AbstractUIPlugin {
	...
	protected void fillItemProviderFactories(List<AdapterFactory> factories) {
		factories
				.add(new CapOverTime.provider.CapOverTimeItemProviderAdapterFactory());
	...
	public void setLinkConstraints(
			CapOverTime.diagram.edit.policies.CapOverTimeBaseItemSemanticEditPolicy.LinkConstraints lc) {
	...
	public void setElementInitializers(
			CapOverTime.diagram.providers.ElementInitializers i) {
		this.initializers = i;
	}
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, CapOverTimeDiagramEditorPlugin.ID,
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, CapOverTimeDiagramEditorPlugin.ID,
