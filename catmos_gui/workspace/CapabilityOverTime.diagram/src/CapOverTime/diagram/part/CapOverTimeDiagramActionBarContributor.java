 ...
 * @generated
 */
public class CapOverTimeDiagramActionBarContributor extends
	...
	protected Class getEditorClass() {
		return CapOverTime.diagram.part.CapOverTimeDiagramEditor.class;
	}
	...
	public void init(IActionBars bars, IWorkbenchPage page) {
		...
		IAction validateAction = new CapOverTime.diagram.part.ValidateAction(
				page);
