 ...
 * @generated
 */
public class CapOverTimeCreationWizardPage extends WizardNewFileCreationPage {
	...
	protected boolean validatePage() {
		...
		if (extension != null
			...
			setErrorMessage(NLS
					.bind(CapOverTime.diagram.part.Messages.CapOverTimeCreationWizardPageExtensionError,
							extension));
			return false;
		}
		return true;
