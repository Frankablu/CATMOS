 ...
 * @generated
 */
public class SimpleScenarioElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public SimpleScenarioElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						SimpleScenario.diagram.part.Messages.SimpleScenarioElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "SimpleScenario".equals(fileExtension); //$NON-NLS-1$
	}
