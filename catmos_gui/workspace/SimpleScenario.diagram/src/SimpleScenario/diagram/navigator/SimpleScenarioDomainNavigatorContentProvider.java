 ...
 * @generated
 */
public class SimpleScenarioDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public SimpleScenarioDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof SimpleScenario.diagram.navigator.SimpleScenarioDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((SimpleScenario.diagram.navigator.SimpleScenarioDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new SimpleScenario.diagram.navigator.SimpleScenarioDomainNavigatorItem(
