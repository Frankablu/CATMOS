...
public class CapabilityNameColourEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new SimpleScenario.diagram.edit.policies.SimpleScenarioTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SimpleScenario.diagram.providers.SimpleScenarioParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(
					this,
					null,
					SimpleScenario.diagram.edit.parts.SimpleScenarioEditPartFactory
