...
public class Capability2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new SimpleScenario.diagram.edit.policies.Capability2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SimpleScenario.diagram.edit.parts.CapabilityNameColour2EditPart) {
			((SimpleScenario.diagram.edit.parts.CapabilityNameColour2EditPart) childEditPart)
