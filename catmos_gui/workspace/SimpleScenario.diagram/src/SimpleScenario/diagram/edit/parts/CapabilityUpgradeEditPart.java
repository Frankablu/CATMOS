...
public class CapabilityUpgradeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new SimpleScenario.diagram.edit.policies.CapabilityUpgradeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SimpleScenario.diagram.edit.parts.CapabilityUpgradeNameEditPart) {
			((SimpleScenario.diagram.edit.parts.CapabilityUpgradeNameEditPart) childEditPart)
