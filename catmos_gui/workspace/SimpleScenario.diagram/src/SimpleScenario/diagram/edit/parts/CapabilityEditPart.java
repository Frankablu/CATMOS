...
public class CapabilityEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new SimpleScenario.diagram.edit.policies.CapabilityItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SimpleScenario.diagram.edit.parts.CapabilityNameColourEditPart) {
			((SimpleScenario.diagram.edit.parts.CapabilityNameColourEditPart) childEditPart)
