 ...
 * @generated
 */
public class SimpleScenarioCreateShortcutDecorationsCommand extends
	 ...
	 * @generated
	 */
	public SimpleScenarioCreateShortcutDecorationsCommand(
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		for (Iterator it = myDescriptors.iterator(); it.hasNext();) {
			...
			if (view != null && view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				...
				shortcutAnnotation
						.getDetails()
						.put("modelID", SimpleScenario.diagram.edit.parts.ScenarioEditPart.MODEL_ID); //$NON-NLS-1$
