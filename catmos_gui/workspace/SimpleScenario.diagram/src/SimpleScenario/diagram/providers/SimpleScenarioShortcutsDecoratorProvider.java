 ...
 * @generated
 */
public class SimpleScenarioShortcutsDecoratorProvider extends AbstractProvider
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		public void refresh() {
			...
			EditPart editPart = (EditPart) getDecoratorTarget().getAdapter(
					EditPart.class);
			Image image = SimpleScenario.diagram.part.SimpleScenarioDiagramEditorPlugin
