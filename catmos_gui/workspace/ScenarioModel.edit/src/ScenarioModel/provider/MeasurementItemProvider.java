...
/**
 * This is the item provider adapter for a {@link ScenarioModel.Measurement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ScenarioModelPackage.Literals.MEASUREMENT__NAME,
         true,
         false,
         false,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ScenarioModelPackage.Literals.MEASUREMENT__CRITICAL_VALUE,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ScenarioModelPackage.Literals.MEASUREMENT__BENCHMARK_VALUE,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ScenarioModelPackage.Literals.MEASUREMENT__PROVIDED_VALUE,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ScenarioModelPackage.Literals.MEASUREMENT__SCRIPT,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(ScenarioModelPackage.Literals.MEASUREMENT__CRITICAL_VALUES);
      childrenFeatures.add(ScenarioModelPackage.Literals.MEASUREMENT__BENCHMARK_VALUES);
      childrenFeatures.add(ScenarioModelPackage.Literals.MEASUREMENT__PROVIDED_VALUES);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (ScenarioModelPackage.Literals.MEASUREMENT__CRITICAL_VALUES,
         ScenarioModelFactory.eINSTANCE.createQualitativeValue()));

    newChildDescriptors.add
      (createChildParameter
        (ScenarioModelPackage.Literals.MEASUREMENT__BENCHMARK_VALUES,
         ScenarioModelFactory.eINSTANCE.createQualitativeValue()));

    newChildDescriptors.add
      (createChildParameter
        (ScenarioModelPackage.Literals.MEASUREMENT__PROVIDED_VALUES,
         ScenarioModelFactory.eINSTANCE.createQualitativeValue()));
  }
  ...
  public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection)
  {
    ...
    boolean qualify =
      childFeature == ScenarioModelPackage.Literals.MEASUREMENT__CRITICAL_VALUES ||
      childFeature == ScenarioModelPackage.Literals.MEASUREMENT__BENCHMARK_VALUES ||
      childFeature == ScenarioModelPackage.Literals.MEASUREMENT__PROVIDED_VALUES;
