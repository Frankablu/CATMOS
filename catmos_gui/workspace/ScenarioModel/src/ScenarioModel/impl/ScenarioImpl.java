 ...
 * <ul>
 *   <li>{@link ScenarioModel.impl.ScenarioImpl#getOurObjects <em>Our Objects</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScenarioImpl extends EObjectImpl implements Scenario
{
  ...
  {
    return ScenarioModelPackage.Literals.SCENARIO;
  }
  ...
  public EList<OurObject> getOurObjects()
  {
    if (ourObjects == null)
    {
      ourObjects = new EObjectContainmentEList<OurObject>(OurObject.class, this, ScenarioModelPackage.SCENARIO__OUR_OBJECTS);
    }
    return ourObjects;
  }
