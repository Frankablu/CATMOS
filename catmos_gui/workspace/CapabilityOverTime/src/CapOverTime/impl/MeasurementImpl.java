 ...
 * <ul>
 *   <li>{@link CapOverTime.impl.MeasurementImpl#getName <em>Name</em>}</li>
 *   <li>{@link CapOverTime.impl.MeasurementImpl#getCriticalValue <em>Critical Value</em>}</li>
 *   <li>{@link CapOverTime.impl.MeasurementImpl#getBenchmarkValue <em>Benchmark Value</em>}</li>
 *   <li>{@link CapOverTime.impl.MeasurementImpl#getProvidedValue <em>Provided Value</em>}</li>
 *   <li>{@link CapOverTime.impl.MeasurementImpl#getCriticalValues <em>Critical Values</em>}</li>
 *   <li>{@link CapOverTime.impl.MeasurementImpl#getBenchmarkValues <em>Benchmark Values</em>}</li>
 *   <li>{@link CapOverTime.impl.MeasurementImpl#getProvidedValues <em>Provided Values</em>}</li>
 *   <li>{@link CapOverTime.impl.MeasurementImpl#getScript <em>Script</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MeasurementImpl extends EObjectImpl implements Measurement
{
  ...
  {
    return CapOverTimePackage.Literals.MEASUREMENT;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CapOverTimePackage.MEASUREMENT__NAME, oldName, name));
  }
  ...
  public void setCriticalValue(Float newCriticalValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CapOverTimePackage.MEASUREMENT__CRITICAL_VALUE, oldCriticalValue, criticalValue));
  }
  ...
  public void setBenchmarkValue(Float newBenchmarkValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CapOverTimePackage.MEASUREMENT__BENCHMARK_VALUE, oldBenchmarkValue, benchmarkValue));
  }
  ...
  public void setProvidedValue(Float newProvidedValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CapOverTimePackage.MEASUREMENT__PROVIDED_VALUE, oldProvidedValue, providedValue));
  }
  ...
  public EList<QualitativeValue> getCriticalValues()
  {
    ...
    {
      criticalValues = new EObjectContainmentEList<QualitativeValue>(QualitativeValue.class, this, CapOverTimePackage.MEASUREMENT__CRITICAL_VALUES);
    }
  ...
  public EList<QualitativeValue> getBenchmarkValues()
  {
    ...
    {
      benchmarkValues = new EObjectContainmentEList<QualitativeValue>(QualitativeValue.class, this, CapOverTimePackage.MEASUREMENT__BENCHMARK_VALUES);
    }
  ...
  public EList<QualitativeValue> getProvidedValues()
  {
    ...
    {
      providedValues = new EObjectContainmentEList<QualitativeValue>(QualitativeValue.class, this, CapOverTimePackage.MEASUREMENT__PROVIDED_VALUES);
    }
  ...
  public void setScript(String newScript)
  {
    ...
    script = newScript;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CapOverTimePackage.MEASUREMENT__SCRIPT, oldScript, script));
  }
