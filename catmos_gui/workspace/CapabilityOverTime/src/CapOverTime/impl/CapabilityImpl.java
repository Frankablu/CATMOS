 ...
 * <ul>
 *   <li>{@link CapOverTime.impl.CapabilityImpl#getName <em>Name</em>}</li>
 *   <li>{@link CapOverTime.impl.CapabilityImpl#getSearchObjective <em>Search Objective</em>}</li>
 *   <li>{@link CapOverTime.impl.CapabilityImpl#getStandAlone <em>Stand Alone</em>}</li>
 *   <li>{@link CapOverTime.impl.CapabilityImpl#getReuse <em>Reuse</em>}</li>
 *   <li>{@link CapOverTime.impl.CapabilityImpl#getStartDate <em>Start Date</em>}</li>
 *   <li>{@link CapOverTime.impl.CapabilityImpl#getEndDate <em>End Date</em>}</li>
 *   <li>{@link CapOverTime.impl.CapabilityImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link CapOverTime.impl.CapabilityImpl#getColour <em>Colour</em>}</li>
 *   <li>{@link CapOverTime.impl.CapabilityImpl#getAccumulation <em>Accumulation</em>}</li>
 *   <li>{@link CapOverTime.impl.CapabilityImpl#getMeasurements <em>Measurements</em>}</li>
 *   <li>{@link CapOverTime.impl.CapabilityImpl#getDecomposes <em>Decomposes</em>}</li>
 *   <li>{@link CapOverTime.impl.CapabilityImpl#getSatisfiedBy <em>Satisfied By</em>}</li>
 *   <li>{@link CapOverTime.impl.CapabilityImpl#getSatisfies <em>Satisfies</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CapabilityImpl extends OurObjectImpl implements Capability
{
  ...
  {
    return CapOverTimePackage.Literals.CAPABILITY;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CapOverTimePackage.CAPABILITY__NAME, oldName, name));
  }
  ...
  public void setSearchObjective(Boolean newSearchObjective)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CapOverTimePackage.CAPABILITY__SEARCH_OBJECTIVE, oldSearchObjective, searchObjective));
  }
  ...
  public void setStandAlone(Boolean newStandAlone)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CapOverTimePackage.CAPABILITY__STAND_ALONE, oldStandAlone, standAlone));
  }
  ...
  public void setReuse(Integer newReuse)
  {
    ...
    reuse = newReuse;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CapOverTimePackage.CAPABILITY__REUSE, oldReuse, reuse));
  }
  ...
  public void setStartDate(String newStartDate)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CapOverTimePackage.CAPABILITY__START_DATE, oldStartDate, startDate));
  }
  ...
  public void setEndDate(String newEndDate)
  {
    ...
    endDate = newEndDate;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CapOverTimePackage.CAPABILITY__END_DATE, oldEndDate, endDate));
  }
  ...
  public void setStatus(Float newStatus)
  {
    ...
    status = newStatus;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CapOverTimePackage.CAPABILITY__STATUS, oldStatus, status));
  }
  ...
  public void setColour(String newColour)
  {
    ...
    colour = newColour;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CapOverTimePackage.CAPABILITY__COLOUR, oldColour, colour));
  }
  ...
  public Measurement getAccumulation()
  {
    if (accumulation != null && accumulation.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, CapOverTimePackage.CAPABILITY__ACCUMULATION, oldAccumulation, accumulation));
      }
    }
    return accumulation;
  }
  ...
  public void setAccumulation(Measurement newAccumulation)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CapOverTimePackage.CAPABILITY__ACCUMULATION, oldAccumulation, accumulation));
  }
  ...
  public EList<Measurement> getMeasurements()
  {
    ...
    {
      measurements = new EObjectContainmentEList<Measurement>(Measurement.class, this, CapOverTimePackage.CAPABILITY__MEASUREMENTS);
    }
    return measurements;
  }
  ...
  public EList<Capability> getDecomposes()
  {
    if (decomposes == null)
    {
      decomposes = new EObjectResolvingEList<Capability>(Capability.class, this, CapOverTimePackage.CAPABILITY__DECOMPOSES);
    }
    return decomposes;
  }
  ...
  public EList<Capability> getSatisfiedBy()
  {
    if (satisfiedBy == null)
    {
      satisfiedBy = new EObjectWithInverseResolvingEList.ManyInverse<Capability>(Capability.class, this, CapOverTimePackage.CAPABILITY__SATISFIED_BY, CapOverTimePackage.CAPABILITY__SATISFIES);
    }
    return satisfiedBy;
  }
  ...
  public EList<Capability> getSatisfies()
  {
    if (satisfies == null)
    {
      satisfies = new EObjectWithInverseResolvingEList.ManyInverse<Capability>(Capability.class, this, CapOverTimePackage.CAPABILITY__SATISFIES, CapOverTimePackage.CAPABILITY__SATISFIED_BY);
    }
    return satisfies;
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CapOverTimePackage.CAPABILITY__SATISFIED_BY:
        return ((InternalEList<InternalEObject>)(InternalEList<?>)getSatisfiedBy()).basicAdd(otherEnd, msgs);
      case CapOverTimePackage.CAPABILITY__SATISFIES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case CapOverTimePackage.CAPABILITY__COLOUR:
        return getColour();
      case CapOverTimePackage.CAPABILITY__ACCUMULATION:
        if (resolve) return getAccumulation();
        return basicGetAccumulation();
      case CapOverTimePackage.CAPABILITY__MEASUREMENTS:
        return getMeasurements();
      case CapOverTimePackage.CAPABILITY__DECOMPOSES:
