 ...
 * @generated
 */
public class ScenarioModelElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public ScenarioModelElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						ScenarioModel.diagram.part.Messages.ScenarioModelElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "ScenarioModel".equals(fileExtension); //$NON-NLS-1$
	}
