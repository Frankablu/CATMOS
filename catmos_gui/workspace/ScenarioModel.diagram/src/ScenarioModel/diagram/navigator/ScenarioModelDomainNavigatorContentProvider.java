 ...
 * @generated
 */
public class ScenarioModelDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public ScenarioModelDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof ScenarioModel.diagram.navigator.ScenarioModelDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((ScenarioModel.diagram.navigator.ScenarioModelDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new ScenarioModel.diagram.navigator.ScenarioModelDomainNavigatorItem(
