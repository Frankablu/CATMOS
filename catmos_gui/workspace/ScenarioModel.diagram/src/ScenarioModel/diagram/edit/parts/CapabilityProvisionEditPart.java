 ...
 * @generated
 */
public class CapabilityProvisionEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public CapabilityProvisionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ScenarioModel.diagram.edit.policies.CapabilityProvisionItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.CapabilityProvisionNameEditPart) {
			((ScenarioModel.diagram.edit.parts.CapabilityProvisionNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCapabilityProvisionLabelFigure());
			return true;
		}
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.CapabilityProvisionCapabilityProvisionMeasurementsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getCapabilityProvisionMeasurementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ScenarioModel.diagram.edit.parts.CapabilityProvisionCapabilityProvisionMeasurementsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.CapabilityProvisionCapabilityProvisionMeasurementsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getCapabilityProvisionMeasurementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((ScenarioModel.diagram.edit.parts.CapabilityProvisionCapabilityProvisionMeasurementsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
