 ...
 * @generated
 */
public class CapabilityProvision4EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public CapabilityProvision4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ScenarioModel.diagram.edit.policies.CapabilityProvision4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.CapabilityProvisionName4EditPart) {
			((ScenarioModel.diagram.edit.parts.CapabilityProvisionName4EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCapabilityProvisionLabelFigure());
			return true;
		}
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.CapabilityProvisionCapabilityProvisionMeasurementsCompartment4EditPart) {
			IFigure pane = getPrimaryShape()
					.getCapabilityProvisionMeasurementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ScenarioModel.diagram.edit.parts.CapabilityProvisionCapabilityProvisionMeasurementsCompartment4EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.CapabilityProvisionCapabilityProvisionMeasurementsCompartment4EditPart) {
			IFigure pane = getPrimaryShape()
					.getCapabilityProvisionMeasurementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((ScenarioModel.diagram.edit.parts.CapabilityProvisionCapabilityProvisionMeasurementsCompartment4EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
