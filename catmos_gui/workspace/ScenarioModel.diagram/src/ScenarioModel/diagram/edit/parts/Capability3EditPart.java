...
public class Capability3EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ScenarioModel.diagram.edit.policies.Capability3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.CapabilityNameColour3EditPart) {
			((ScenarioModel.diagram.edit.parts.CapabilityNameColour3EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCapabilityLabelFigure());
			return true;
		}
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.CapabilityCapabilityMeasurementsCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getCapabilityMeasurementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ScenarioModel.diagram.edit.parts.CapabilityCapabilityMeasurementsCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.CapabilityCapabilityMeasurementsCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getCapabilityMeasurementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((ScenarioModel.diagram.edit.parts.CapabilityCapabilityMeasurementsCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
