...
public class ComponentEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ScenarioModel.diagram.edit.policies.ComponentItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.ComponentNameEditPart) {
			((ScenarioModel.diagram.edit.parts.ComponentNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureComponentLabelFigure());
			return true;
		}
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.ComponentComponentProvidesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getComponentProvidesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ScenarioModel.diagram.edit.parts.ComponentComponentProvidesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.ComponentComponentUpgradesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getComponentUpgradesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ScenarioModel.diagram.edit.parts.ComponentComponentUpgradesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.ComponentComponentRequiresCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getComponentRequiresCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ScenarioModel.diagram.edit.parts.ComponentComponentRequiresCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.ComponentComponentCostsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getComponentCostsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ScenarioModel.diagram.edit.parts.ComponentComponentCostsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.ComponentComponentProvidesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getComponentProvidesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((ScenarioModel.diagram.edit.parts.ComponentComponentProvidesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.ComponentComponentUpgradesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getComponentUpgradesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((ScenarioModel.diagram.edit.parts.ComponentComponentUpgradesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.ComponentComponentRequiresCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getComponentRequiresCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((ScenarioModel.diagram.edit.parts.ComponentComponentRequiresCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.ComponentComponentCostsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getComponentCostsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((ScenarioModel.diagram.edit.parts.ComponentComponentCostsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	public List<IElementType> getMARelTypesOnTarget() {
		...
		types.add(ScenarioModel.diagram.providers.ScenarioModelElementTypes.CapabilityUpgradeUpgrading_4005);
		return types;
	}
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		...
		if (relationshipType == ScenarioModel.diagram.providers.ScenarioModelElementTypes.CapabilityUpgradeUpgrading_4005) {
	...
	public class ComponentFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private RectangleFigure fComponentCostsCompartmentFigure;
		...
		private void createContents() {
			...
			fComponentCostsCompartmentFigure = new RectangleFigure();
		 ...
		 * @generated
		 */
		public RectangleFigure getComponentCostsCompartmentFigure() {
