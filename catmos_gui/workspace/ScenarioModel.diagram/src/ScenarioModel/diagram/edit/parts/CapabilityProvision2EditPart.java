 ...
 * @generated
 */
public class CapabilityProvision2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public CapabilityProvision2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ScenarioModel.diagram.edit.policies.CapabilityProvision2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.CapabilityProvisionName2EditPart) {
			((ScenarioModel.diagram.edit.parts.CapabilityProvisionName2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCapabilityProvisionLabelFigure());
			return true;
		}
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.CapabilityProvisionCapabilityProvisionMeasurementsCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getCapabilityProvisionMeasurementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ScenarioModel.diagram.edit.parts.CapabilityProvisionCapabilityProvisionMeasurementsCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.CapabilityProvisionCapabilityProvisionMeasurementsCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getCapabilityProvisionMeasurementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((ScenarioModel.diagram.edit.parts.CapabilityProvisionCapabilityProvisionMeasurementsCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
