 ...
 * @generated
 */
public class Capability4EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Capability4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ScenarioModel.diagram.edit.policies.Capability4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.CapabilityNameColour4EditPart) {
			((ScenarioModel.diagram.edit.parts.CapabilityNameColour4EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCapabilityLabelFigure());
			return true;
		}
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.CapabilityCapabilityMeasurementsCompartment4EditPart) {
			IFigure pane = getPrimaryShape()
					.getCapabilityMeasurementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ScenarioModel.diagram.edit.parts.CapabilityCapabilityMeasurementsCompartment4EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.CapabilityCapabilityMeasurementsCompartment4EditPart) {
			IFigure pane = getPrimaryShape()
					.getCapabilityMeasurementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((ScenarioModel.diagram.edit.parts.CapabilityCapabilityMeasurementsCompartment4EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
