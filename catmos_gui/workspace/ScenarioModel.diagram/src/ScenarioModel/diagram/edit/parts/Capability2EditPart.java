 ...
 * @generated
 */
public class Capability2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Capability2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ScenarioModel.diagram.edit.policies.Capability2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.CapabilityNameColour2EditPart) {
			((ScenarioModel.diagram.edit.parts.CapabilityNameColour2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCapabilityLabelFigure());
			return true;
		}
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.CapabilityCapabilityMeasurementsCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getCapabilityMeasurementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ScenarioModel.diagram.edit.parts.CapabilityCapabilityMeasurementsCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ScenarioModel.diagram.edit.parts.CapabilityCapabilityMeasurementsCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getCapabilityMeasurementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((ScenarioModel.diagram.edit.parts.CapabilityCapabilityMeasurementsCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
