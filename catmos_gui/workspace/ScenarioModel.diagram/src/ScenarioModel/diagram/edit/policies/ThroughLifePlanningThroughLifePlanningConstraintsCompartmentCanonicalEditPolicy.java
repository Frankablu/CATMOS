 ...
 * @generated
 */
public class ThroughLifePlanningThroughLifePlanningConstraintsCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getThroughLifePlanningThroughLifePlanningConstraintsCompartment_7008SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = ScenarioModel.diagram.part.ScenarioModelVisualIDRegistry
				.getVisualID(view);
		return visualID == ScenarioModel.diagram.edit.parts.DesireHigh2EditPart.VISUAL_ID
				|| visualID == ScenarioModel.diagram.edit.parts.DesireLow2EditPart.VISUAL_ID
				|| visualID == ScenarioModel.diagram.edit.parts.Budget2EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getThroughLifePlanningThroughLifePlanningConstraintsCompartment_7008SemanticChildren((View) getHost()
						.getModel());
