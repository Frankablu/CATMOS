 ...
 * @generated
 */
public class FindTradeOffsFindTradeOffsConstraintsCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getFindTradeOffsFindTradeOffsConstraintsCompartment_7006SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = ScenarioModel.diagram.part.ScenarioModelVisualIDRegistry
				.getVisualID(view);
		return visualID == ScenarioModel.diagram.edit.parts.DesireHighEditPart.VISUAL_ID
				|| visualID == ScenarioModel.diagram.edit.parts.DesireLowEditPart.VISUAL_ID
				|| visualID == ScenarioModel.diagram.edit.parts.BudgetEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getFindTradeOffsFindTradeOffsConstraintsCompartment_7006SemanticChildren((View) getHost()
						.getModel());
