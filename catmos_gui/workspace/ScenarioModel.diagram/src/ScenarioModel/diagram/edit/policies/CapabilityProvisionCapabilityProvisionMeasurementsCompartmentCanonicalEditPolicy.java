 ...
 * @generated
 */
public class CapabilityProvisionCapabilityProvisionMeasurementsCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getCapabilityProvisionCapabilityProvisionMeasurementsCompartment_7001SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getCapabilityProvisionCapabilityProvisionMeasurementsCompartment_7001SemanticChildren((View) getHost()
						.getModel());
