 ...
 * @generated
 */
public class CapabilityCapabilityMeasurementsCompartment4CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getCapabilityCapabilityMeasurementsCompartment_7021SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getCapabilityCapabilityMeasurementsCompartment_7021SemanticChildren((View) getHost()
						.getModel());
