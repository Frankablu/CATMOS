 ...
 * @generated
 */
public class CapabilityCapabilityMeasurementsCompartment2CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getCapabilityCapabilityMeasurementsCompartment_7016SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getCapabilityCapabilityMeasurementsCompartment_7016SemanticChildren((View) getHost()
						.getModel());
