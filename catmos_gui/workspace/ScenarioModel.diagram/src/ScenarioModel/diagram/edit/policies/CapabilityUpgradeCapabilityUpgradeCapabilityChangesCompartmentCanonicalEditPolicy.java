 ...
 * @generated
 */
public class CapabilityUpgradeCapabilityUpgradeCapabilityChangesCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getCapabilityUpgradeCapabilityUpgradeCapabilityChangesCompartment_7018SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ScenarioModel.diagram.edit.parts.CapabilityChangeEditPart.VISUAL_ID == ScenarioModel.diagram.part.ScenarioModelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getCapabilityUpgradeCapabilityUpgradeCapabilityChangesCompartment_7018SemanticChildren((View) getHost()
						.getModel());
