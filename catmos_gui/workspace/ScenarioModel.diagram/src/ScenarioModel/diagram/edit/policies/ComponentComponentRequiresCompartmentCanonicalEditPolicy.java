...
public class ComponentComponentRequiresCompartmentCanonicalEditPolicy extends
	...
	protected List getSemanticChildrenList() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getComponentComponentRequiresCompartment_7012SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = ScenarioModel.diagram.part.ScenarioModelVisualIDRegistry
				.getVisualID(view);
		return visualID == ScenarioModel.diagram.edit.parts.CapabilityProvision3EditPart.VISUAL_ID
				|| visualID == ScenarioModel.diagram.edit.parts.Capability3EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getComponentComponentRequiresCompartment_7012SemanticChildren((View) getHost()
						.getModel());
