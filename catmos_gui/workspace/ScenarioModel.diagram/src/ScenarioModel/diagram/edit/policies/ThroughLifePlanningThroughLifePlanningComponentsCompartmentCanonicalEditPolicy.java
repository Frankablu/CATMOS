 ...
 * @generated
 */
public class ThroughLifePlanningThroughLifePlanningComponentsCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getThroughLifePlanningThroughLifePlanningComponentsCompartment_7007SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = ScenarioModel.diagram.part.ScenarioModelVisualIDRegistry
				.getVisualID(view);
		return visualID == ScenarioModel.diagram.edit.parts.ExistingComponent2EditPart.VISUAL_ID
				|| visualID == ScenarioModel.diagram.edit.parts.AcquirableComponent2EditPart.VISUAL_ID
				|| visualID == ScenarioModel.diagram.edit.parts.ComponentU2EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getThroughLifePlanningThroughLifePlanningComponentsCompartment_7007SemanticChildren((View) getHost()
						.getModel());
