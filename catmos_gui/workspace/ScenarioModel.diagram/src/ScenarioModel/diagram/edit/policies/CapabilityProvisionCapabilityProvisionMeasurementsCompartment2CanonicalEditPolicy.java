 ...
 * @generated
 */
public class CapabilityProvisionCapabilityProvisionMeasurementsCompartment2CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getCapabilityProvisionCapabilityProvisionMeasurementsCompartment_7014SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ScenarioModel.diagram.edit.parts.MeasurementEditPart.VISUAL_ID == ScenarioModel.diagram.part.ScenarioModelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getCapabilityProvisionCapabilityProvisionMeasurementsCompartment_7014SemanticChildren((View) getHost()
						.getModel());
