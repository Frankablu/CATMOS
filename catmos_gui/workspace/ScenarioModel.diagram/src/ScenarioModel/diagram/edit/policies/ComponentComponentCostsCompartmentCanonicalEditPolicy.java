 ...
 * @generated
 */
public class ComponentComponentCostsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getComponentComponentCostsCompartment_7013SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ScenarioModel.diagram.edit.parts.CostEditPart.VISUAL_ID == ScenarioModel.diagram.part.ScenarioModelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getComponentComponentCostsCompartment_7013SemanticChildren((View) getHost()
						.getModel());
