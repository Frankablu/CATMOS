 ...
 * @generated
 */
public class CapabilityCapabilityMeasurementsCompartment3CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getCapabilityCapabilityMeasurementsCompartment_7017SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getCapabilityCapabilityMeasurementsCompartment_7017SemanticChildren((View) getHost()
						.getModel());
