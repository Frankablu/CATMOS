 ...
 * @generated
 */
public class CapabilityProvisionCapabilityProvisionMeasurementsCompartment4CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getCapabilityProvisionCapabilityProvisionMeasurementsCompartment_7020SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getCapabilityProvisionCapabilityProvisionMeasurementsCompartment_7020SemanticChildren((View) getHost()
						.getModel());
