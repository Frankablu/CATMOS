 ...
 * @generated
 */
public class FindTradeOffsFindTradeOffsComponentsCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getFindTradeOffsFindTradeOffsComponentsCompartment_7005SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = ScenarioModel.diagram.part.ScenarioModelVisualIDRegistry
				.getVisualID(view);
		return visualID == ScenarioModel.diagram.edit.parts.ExistingComponentEditPart.VISUAL_ID
				|| visualID == ScenarioModel.diagram.edit.parts.AcquirableComponentEditPart.VISUAL_ID
				|| visualID == ScenarioModel.diagram.edit.parts.ComponentUEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getFindTradeOffsFindTradeOffsComponentsCompartment_7005SemanticChildren((View) getHost()
						.getModel());
