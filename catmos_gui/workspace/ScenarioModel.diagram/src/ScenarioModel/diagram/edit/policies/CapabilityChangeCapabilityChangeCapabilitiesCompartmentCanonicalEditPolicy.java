 ...
 * @generated
 */
public class CapabilityChangeCapabilityChangeCapabilitiesCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getCapabilityChangeCapabilityChangeCapabilitiesCompartment_7019SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = ScenarioModel.diagram.part.ScenarioModelVisualIDRegistry
				.getVisualID(view);
		return visualID == ScenarioModel.diagram.edit.parts.CapabilityProvision4EditPart.VISUAL_ID
				|| visualID == ScenarioModel.diagram.edit.parts.Capability4EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getCapabilityChangeCapabilityChangeCapabilitiesCompartment_7019SemanticChildren((View) getHost()
						.getModel());
