...
public class ComponentItemSemanticEditPolicy
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (ScenarioModel.diagram.part.ScenarioModelVisualIDRegistry
					.getVisualID(incomingLink) == ScenarioModel.diagram.edit.parts.CapabilityUpgradeUpgradingEditPart.VISUAL_ID) {
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit
					...
					case ScenarioModel.diagram.edit.parts.CapabilityUpgradeEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it
							...
							Edge outgoingLink = (Edge) it.next();
							if (ScenarioModel.diagram.part.ScenarioModelVisualIDRegistry
									.getVisualID(outgoingLink) == ScenarioModel.diagram.edit.parts.CapabilityUpgradeUpgradingEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(),
										null, outgoingLink.getTarget()
												.getElement(), false);
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (ScenarioModel.diagram.providers.ScenarioModelElementTypes.CapabilityUpgradeUpgrading_4005 == req
				.getElementType()) {
			return null;
		}
		return null;
	...
	protected Command getCompleteCreateRelationshipCommand(
		...
		if (ScenarioModel.diagram.providers.ScenarioModelElementTypes.CapabilityUpgradeUpgrading_4005 == req
				.getElementType()) {
			return getGEFWrapper(new ScenarioModel.diagram.edit.commands.CapabilityUpgradeUpgradingCreateCommand(
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case ScenarioModel.diagram.edit.parts.CapabilityUpgradeUpgradingEditPart.VISUAL_ID:
			return getGEFWrapper(new ScenarioModel.diagram.edit.commands.CapabilityUpgradeUpgradingReorientCommand(
					req));
		}
