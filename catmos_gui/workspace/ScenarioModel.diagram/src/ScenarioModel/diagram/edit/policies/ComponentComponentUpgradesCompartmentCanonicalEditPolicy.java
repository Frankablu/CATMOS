...
public class ComponentComponentUpgradesCompartmentCanonicalEditPolicy extends
	...
	protected List getSemanticChildrenList() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getComponentComponentUpgradesCompartment_7011SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ScenarioModel.diagram.edit.parts.CapabilityUpgradeEditPart.VISUAL_ID == ScenarioModel.diagram.part.ScenarioModelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getComponentComponentUpgradesCompartment_7011SemanticChildren((View) getHost()
						.getModel());
