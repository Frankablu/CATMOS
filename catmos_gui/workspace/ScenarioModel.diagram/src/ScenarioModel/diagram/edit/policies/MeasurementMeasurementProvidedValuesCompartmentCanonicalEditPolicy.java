...
public class MeasurementMeasurementProvidedValuesCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getMeasurementMeasurementProvidedValuesCompartment_7004SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ScenarioModel.diagram.edit.parts.QualitativeValue3EditPart.VISUAL_ID == ScenarioModel.diagram.part.ScenarioModelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ScenarioModel.diagram.part.ScenarioModelNodeDescriptor> childDescriptors = ScenarioModel.diagram.part.ScenarioModelDiagramUpdater
				.getMeasurementMeasurementProvidedValuesCompartment_7004SemanticChildren((View) getHost()
						.getModel());
