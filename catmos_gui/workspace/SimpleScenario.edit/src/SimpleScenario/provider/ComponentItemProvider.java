...
/**
 * This is the item provider adapter for a {@link SimpleScenario.Component} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         SimpleScenarioPackage.Literals.COMPONENT__NAME,
         true,
         false,
         false,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         SimpleScenarioPackage.Literals.COMPONENT__START_DATE,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         SimpleScenarioPackage.Literals.COMPONENT__END_DATE,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(SimpleScenarioPackage.Literals.COMPONENT__PROVIDES);
      childrenFeatures.add(SimpleScenarioPackage.Literals.COMPONENT__UPGRADES);
      childrenFeatures.add(SimpleScenarioPackage.Literals.COMPONENT__REQUIRES);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (SimpleScenarioPackage.Literals.COMPONENT__PROVIDES,
         SimpleScenarioFactory.eINSTANCE.createCapability()));

    newChildDescriptors.add
      (createChildParameter
        (SimpleScenarioPackage.Literals.COMPONENT__UPGRADES,
         SimpleScenarioFactory.eINSTANCE.createCapabilityUpgrade()));

    newChildDescriptors.add
      (createChildParameter
        (SimpleScenarioPackage.Literals.COMPONENT__REQUIRES,
         SimpleScenarioFactory.eINSTANCE.createCapability()));
  }
  ...
  public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection)
  {
    ...
    boolean qualify =
      childFeature == SimpleScenarioPackage.Literals.COMPONENT__PROVIDES ||
      childFeature == SimpleScenarioPackage.Literals.COMPONENT__REQUIRES;
